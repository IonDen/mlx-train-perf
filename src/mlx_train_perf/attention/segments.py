"""PackedMask: the packed-sequence segment carrier."""
...
class PackedMask:
    ...
    `break` -- assume contiguous ascending segments, with NO in-kernel guard.
    ...
    def validate(self) -> None:
        ...
        non-decreasing along each row. Never called on the packer/loss path
